...
#define LUASQL_ENVIRONMENT_SQLITE "sqleet environment"
#define LUASQL_CONNECTION_SQLITE "sqleet connection"
#define LUASQL_CURSOR_SQLITE "sqleet cursor"
...
LUASQL_API int luaopen_luasqleet(lua_State *L)
{
  struct luaL_Reg driver[] = {
    {"sqleet", create_environment},
    {NULL, NULL},
  };
  create_metatables (L);
  lua_newtable (L);
